...
<form  action="verMisFotosEtiquetas.php" method="post" enctype="multipart/form-data">
	¿Quieres realizar una busqueda a traves de una etiqueta?
	</br></br>
	<label for="nombre"><b>Introduce tu etiqueta:</b> </label>
<input type="text" name="etiqueta" id="etiqueta">
<input type="hidden" value="<?php echo "$album";?>" name="album" />

<input type="submit" value="BUSCAR">
</form>
	<?php
	echo"</br>";echo"</br>";echo"</br>";
    $directory="Album/$album/";
