...
$us = mysqli_query($mysqli, "select * from Usuario where Correo = '$correo'");
$cont= mysqli_num_rows($us); 
if($cont==1) {
	$sql="update Usuario set Socio='SI' where Correo='$correo'";
	...
	echo"</br></br></br></br></br>"; 
	echo "<h2>EL USUARIO HA SIDO DADO DE ALTA</h2>";
	echo "<a  href='revisarUsuarios.php' > <img src='images/user.png'></a>";
	echo " <a href='revisarUsuarios.php' style='color:#E59866'> DAR DE ALTA MAS USUARIOS </a>";
	echo"</br>";
